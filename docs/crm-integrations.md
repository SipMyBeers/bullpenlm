...
- **Commercial connectors** (Cheers Beers Cloud): authenticated bridges between SaaS CRMs and the file system.
...
- Map HubSpot Deal Stage → Cheers Beers status
- Map HubSpot Owner → Cheers Beers workspace user
